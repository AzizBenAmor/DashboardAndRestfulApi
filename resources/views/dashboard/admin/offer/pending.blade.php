                            ...
                            <table class="table">
                              ...
                              <td>
                                @foreach ($partenaires as $p)
                                    ...
                                    <a href="{{ route('admin.OfferIndex',$p->id) }}" style="color: rgb(0, 0, 0)">  {{ $p->nom }}</a>
                                    @endif
                                @endforeach
                              </td>
                                   <td> <div class="email">
                                 ...
                                 <td> 
                                  ...
                                  <td class="quantity">
                                    ...
                                    @if ($o->stat==0)
                                    <a class="btn btn-phoenix-success me-1 mb-1" style="width: 100px; border: 1px solid rgb(24, 23, 23); " href="{{ route('admin.AcceptOffer',$o->id) }}">Accepter</a>
                                    <a class="btn btn-phoenix-danger me-1 mb-1" style="width: 100px; border: 1px solid rgb(24, 23, 23); " href="{{ route('admin.RefuseOffer',$o->id) }}">Refuser</a> 
                                    @elseif ($o->stat==1)
                                    <a class="btn btn-outline-danger me-1 mb-1" href="{{ route('admin.RefuseOffer',$o->id) }}">Refuser</a> 
                                    @else
                                    <a class="btn btn-phoenix-danger me-1 mb-1" style="width: 100px; border: 1px solid rgb(24, 23, 23); " href="{{ route('admin.AcceptOffer',$o->id) }}">Accepter</a>
                                    @endif
