    ...
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            @enderror
                        ...
                        <div class="alert alert-soft-danger" >{{ Session::get('import_error') }}</div>
                        @endif
                            ...
                            <section class="ftco-section">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            @foreach ($amicale as $am)
                                                @if ($am->id==$a->amicale_id)
                                                <td><a style="color: rgb(0, 0, 0)" href="{{ route('admin.AdherentIndex',$am->id) }}" ><span>{{ $am->nom }} </span></a></td>
                                                @endif
                                            @endforeach
                                            ...
                                            <td>{{ $c->codeBar }}</td>
                                                ...
                                                <td><button class="btn btn-phoenix-success me-1 mb-1" style="width: 100px; border: 1px solid rgb(24, 23, 23); " type="button" data-bs-toggle="modal" data-bs-target="#verticallyCentered{{ $a->id }}">Consulter</button>
                                                  <button class="btn btn-phoenix-primary me-1 mb-1" style="width: 100px; border: 1px solid rgb(24, 23, 23); " type="button" data-bs-toggle="modal" data-bs-target="#exampleModale{{ $a->id }}">Modifier</button>
                                                    ...
                                                    {{-- <a  href="{{ route('admin.Carteblock',$carte->id) }}" class="btn btn-danger">Block </a> --}}
                                               ...
                                               <td><button class="btn btn-phoenix-success me-1 mb-1" style="width: 100px; border: 1px solid rgb(24, 23, 23); " type="button" data-bs-toggle="modal" data-bs-target="#verticallyCentered{{ $a->id }}">Consulter</button>
                                                ...
                                                <a href="{{ route('admin.CarteUnblock',$c->id) }}" class="btn btn-phoenix-success me-1 mb-1" style="width: 100px; border: 1px solid rgb(24, 23, 23); ">Débloquer </a>
