<nav class="navbar navbar-light navbar-top navbar-expand">
    ...
    <div class="collapse navbar-collapse">
      ...
      <div class="search-box d-none d-lg-block" style="width:25rem;">
        <form action="{{ route('admin.SearchAmicale') }}" method="POST" class="position-relative" data-bs-toggle="search" data-bs-display="static">
          @csrf
          <input name="amicale_nom" class="form-control form-control-sm search-input search min-h-auto" type="search" placeholder="Recherche..." aria-label="Search">
