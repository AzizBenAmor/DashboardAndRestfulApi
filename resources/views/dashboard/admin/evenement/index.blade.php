...
@include('dashboard.admin.layout.navevenement')
       <div class="content">
                          ...
                          <tbody>
                            <tr class="alert" role="alert">
                              ...
                              <td>
                               ...
                               <img class="rounded-circle" style="width: 50px;" src="{{ asset('uploads') }}/{{ $e->image }}">
                              ...
                              <td class="quantity">
                                <button class="btn btn-phoenix-success me-1 mb-1" style="width:110px; border: 1px solid rgb(24, 23, 23); " type="button" data-bs-toggle="modal" data-bs-target="#verticallyCentered{{ $e->id }}">Consulter</button>
                                <button class="btn btn-phoenix-primary me-1 mb-1" style="width: 100px; border: 1px solid rgb(24, 23, 23); " type="button" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $e->id }}">Modifier</button>
                                @if ( $e->post == 0)
                                <a class="btn btn-phoenix-success me-1 mb-1" style="width: 110px; border: 1px solid rgb(24, 23, 23); " href="{{ route('admin.EvenementPost',$e->id) }}">Poster</a>
                                @else
                                <a class="btn btn-phoenix-danger me-1 mb-1" style="width: 110px; border: 1px solid rgb(24, 23, 23); " href="{{ route('admin.EvenementUnPost',$e->id) }}">Archiver</a>
                                @endif
                                <a onclick="return confirm('voulez vous vraiment supprimer Cette Evenement ')" class="btn btn-phoenix-danger me-1 mb-1" style=" border: 1px solid rgb(24, 23, 23); " href="{{ route('admin.EvenementDelete',$e->id) }}">Supprimer</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="exampleModalLabel">Ajouter Evenement</h5><button class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times fs--1"></span></button>
    </div>
     
    <div class="modal-body">
  
    
    <form action="{{ route('admin.EvenementStore') }}" method="post" enctype="multipart/form-data">
      @csrf
  
    
    <div class="mb-3">
      <label class="form-label" for="exampleFormControlInput1">titre </label>
      <input name="titre" class="form-control" id="exampleFormControlInput1" type="text" placeholder="Titre de L'Evenement" >
      @error('titre')
...
<div class="modal fade" id="verticallyCentered{{ $s->id }}" tabindex="-1" aria-labelledby="verticallyCenteredModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="scrollingLongModalLabel2">Evenement </h5><button class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times fs--1"></span></button>
          </div>
          <div class="modal-body">
            <div class="d-flex justify-content-center mb-4">
              <div class="p-2"><img class="rounded-none" style="width: 150px;" src="{{ asset('uploads') }}/{{ $s->image }}"></div>
                ...
                <div class="row">
                      ...
                      <div class="col-12" >
                 <strong> Evenement:  </strong>&thinsp;{{ $s->titre}}
...
<div class="modal fade" id="exampleModal{{ $s->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modifier Evenement</h5><button class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times fs--1"></span></button>
      </div>
      <div class="modal-body">
        <form action="{{ route('admin.EvenementUpdate',$s->id) }}" method="post" enctype="multipart/form-data">
          @csrf
      @method('PUT')
