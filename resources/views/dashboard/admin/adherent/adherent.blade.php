            ...
            <div class="content">
                ...
                <div class="pb-5">
                    <div class="row g-5">
                        ...
                        <h1>Liste des Adherents Active </h1>
                        <hr>
                            ...
                            <div class="table-wrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <td>{{ $c->codeBar }}</td>
                                                @if ($c->is_active)
                                           <td> <span class="badge bg-100 text-success  fs--1 px-1 mb-2">Active</span></td>
                                            <td><button class="btn btn-phoenix-success me-1 mb-1" style="width: 100px; border: 1px solid rgb(24, 23, 23); " type="button" data-bs-toggle="modal" data-bs-target="#verticallyCentered{{ $a->id }}">Consulter</button>
                                                ...
                                                <button class="btn btn-phoenix-danger me-1 mb-1" style=" border: 1px solid rgb(24, 23, 23); " type="button" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $c->id }}">Bloquer</button>
